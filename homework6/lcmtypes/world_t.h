...
/**
 * Create a deep copy of a world_t.
 * When no longer needed, destroy it with world_t_destroy()
 */
world_t* world_t_copy(const world_t* to_copy);

/**
 * Destroy an instance of world_t created by world_t_copy()
 */
void world_t_destroy(world_t* to_destroy);

/**
 * Identifies a single subscription.  This is an opaque data type.
 */
typedef struct _world_t_subscription_t world_t_subscription_t;

/**
 * Prototype for a callback function invoked when a message of type
 * world_t is received.
 */
typedef void(*world_t_handler_t)(
    const lcm_recv_buf_t *rbuf, const char *channel,
    const world_t *msg, void *userdata);

/**
 * Publish a message of type world_t using LCM.
 *
 ...
 */
int world_t_publish(lcm_t *lcm, const char *channel, const world_t *msg);

/**
 * Subscribe to messages of type world_t using LCM.
 *
 ...
 */
world_t_subscription_t* world_t_subscribe(
    lcm_t *lcm, const char *channel, world_t_handler_t handler, void *userdata);

/**
 * Removes and destroys a subscription created by world_t_subscribe()
 */
 ...
 * @return 0 on success, <0 if an error occured
 */
int world_t_subscription_set_queue_capacity(
    world_t_subscription_t* subs, int num_messages);

/**
 * Encode a message of type world_t into binary form.
 *
 * @param buf The output buffer.
 * @param offset Encoding starts at this byte offset into @p buf.
 * @param maxlen Maximum number of bytes to write.  This should generally
 *               be equal to world_t_encoded_size().
...
/**
 * Decode a message of type world_t from binary form.
 * When decoding messages containing strings or variable-length arrays, this
 * function may allocate memory.  When finished with the decoded message,
 * release allocated resources with world_t_decode_cleanup().
 *
 ...
 */
int world_t_decode(const void *buf, int offset, int maxlen, world_t *msg);

/**
 * Release resources allocated by world_t_decode()
 * @return 0
 */
int world_t_decode_cleanup(world_t *p);

/**
 * Check how many bytes are required to encode a message of type world_t
 */
...
int __world_t_encode_array(
    void *buf, int offset, int maxlen, const world_t *p, int elements);
int __world_t_decode_array(
    const void *buf, int offset, int maxlen, world_t *p, int elements);
