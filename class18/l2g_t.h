...
/**
 * Create a deep copy of a l2g_t.
 * When no longer needed, destroy it with l2g_t_destroy()
 */
l2g_t* l2g_t_copy(const l2g_t* to_copy);

/**
 * Destroy an instance of l2g_t created by l2g_t_copy()
 */
void l2g_t_destroy(l2g_t* to_destroy);

/**
 * Identifies a single subscription.  This is an opaque data type.
 */
typedef struct _l2g_t_subscription_t l2g_t_subscription_t;

/**
 * Prototype for a callback function invoked when a message of type
 * l2g_t is received.
 */
typedef void(*l2g_t_handler_t)(
    const lcm_recv_buf_t *rbuf, const char *channel,
    const l2g_t *msg, void *userdata);

/**
 * Publish a message of type l2g_t using LCM.
 *
 ...
 */
int l2g_t_publish(lcm_t *lcm, const char *channel, const l2g_t *msg);

/**
 * Subscribe to messages of type l2g_t using LCM.
 *
 ...
 */
l2g_t_subscription_t* l2g_t_subscribe(
    lcm_t *lcm, const char *channel, l2g_t_handler_t handler, void *userdata);

/**
 * Removes and destroys a subscription created by l2g_t_subscribe()
 */
 ...
 * @return 0 on success, <0 if an error occured
 */
int l2g_t_subscription_set_queue_capacity(
    l2g_t_subscription_t* subs, int num_messages);

/**
 * Encode a message of type l2g_t into binary form.
 *
 * @param buf The output buffer.
 * @param offset Encoding starts at this byte offset into @p buf.
 * @param maxlen Maximum number of bytes to write.  This should generally
 *               be equal to l2g_t_encoded_size().
...
/**
 * Decode a message of type l2g_t from binary form.
 * When decoding messages containing strings or variable-length arrays, this
 * function may allocate memory.  When finished with the decoded message,
 * release allocated resources with l2g_t_decode_cleanup().
 *
 ...
 */
int l2g_t_decode(const void *buf, int offset, int maxlen, l2g_t *msg);

/**
 * Release resources allocated by l2g_t_decode()
 * @return 0
 */
int l2g_t_decode_cleanup(l2g_t *p);

/**
 * Check how many bytes are required to encode a message of type l2g_t
 */
...
int __l2g_t_encode_array(
    void *buf, int offset, int maxlen, const l2g_t *p, int elements);
int __l2g_t_decode_array(
    const void *buf, int offset, int maxlen, l2g_t *p, int elements);
